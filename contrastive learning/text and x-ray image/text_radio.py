...
def load_rococo_dataset():
    train_path = "../../datasets/rococo/all_data/train/radiology"
    test_path = "../../datasets/rococo/all_data/test/radiology"
    val_path = "../../datasets/rococo/all_data/validation/radiology"
...
class TextRadioEncoder(nn.Module):
    def __init__(self, device='cpu', modality_token_encoder=ModalityTokenEncoder(), checkpoint="../text_image_add/text_image.pt",
        ...
        super(TextRadioEncoder, self).__init__(*args, **kwargs)
...
def main(basic_train=True):
    ...
    model = TextRadioEncoder(device=CFG.device)
