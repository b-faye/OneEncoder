...
class UniversalProjectionEncoder(nn.Module):
    def __init__(self, input_dim=CFG.projection_dim, num_head=CFG.num_head, num_layers=CFG.num_layers, token_size=CFG.token_size, *args, **kwargs):
        """
    ...
    def forward(self, inputs):
        ...
        # Drop tokens
        residual_output = residual_output[:, self.token_size:, :]
