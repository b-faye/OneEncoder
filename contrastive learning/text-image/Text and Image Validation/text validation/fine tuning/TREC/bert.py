...
def collate_fn(batch: List[Tuple[str, int]], tokenizer: BertTokenizer, max_length: int) -> Tuple[
...
class BERTClassifier(nn.Module):
    def __init__(self, bert_model, hidden_size=768, num_labels=6):
...
def main():
    ...
    model = BERTClassifier(bert_model, num_labels=6)
