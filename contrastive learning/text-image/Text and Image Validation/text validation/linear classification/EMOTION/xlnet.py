...
class XLNetClassifier(nn.Module):
    def __init__(self, xlnet_model, hidden_size=768, num_labels=6):  # Adjust num_labels for EMOTION dataset
...
def main():
    ...
    model = XLNetClassifier(xlnet_model, num_labels=6)  # Adjust num_labels for EMOTION dataset
