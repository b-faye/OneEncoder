...
class BERTClassifier(nn.Module):
    def __init__(self, bert_model, hidden_size=768, num_labels=6):  # Assuming 6 emotion labels
...
def main():
    ...
    model = BERTClassifier(bert_model, num_labels=6)  # Adjust num_labels for EMOTION dataset
