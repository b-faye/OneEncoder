...
def collate_fn(batch: List[Tuple[str, int]], tokenizer: RobertaTokenizer, max_length: int) -> Tuple[
...
class RoBERTaClassifier(nn.Module):
    def __init__(self, roberta_model, hidden_size=768, num_labels=6):
...
def main():
    ...
    model = RoBERTaClassifier(roberta_model, num_labels=6)
