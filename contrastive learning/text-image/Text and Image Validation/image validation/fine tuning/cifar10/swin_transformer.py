...
def main(trainable=True, epochs=100, device=CFG.device):
    ...
    train_data = CustomCIFAR10Dataset(train_data, transform=text_image_encoder.image_preprocessor)
    test_data = torchvision.datasets.CIFAR10(root='./data', train=False, download=True)
    test_data = CustomCIFAR10Dataset(test_data, transform=text_image_encoder.image_preprocessor)
    # DataLoader
