...
class LinearClassifier(nn.Module):
    def __init__(self, pretrained_model, num_classes=101, trainable=False, device='cpu', *args, **kwargs):
        ...
        self.classifier = nn.Sequential(
            nn.Linear(self.model.universal_projection_encoder.input_dim, 512),
...
def main(model_path="text_image.pt", trainable=False, epochs=100, device=CFG.device):
    ...
    train_data = CustomCaltech101Dataset(train_data, transform=pretrained_model.image_preprocessor)
    test_data = CustomCaltech101Dataset(test_data, transform=pretrained_model.image_preprocessor)
