...
def main(model_path="text_image.pt", trainable=False, epochs=100, device=CFG.device):
    ...
    train_data = CustomCIFAR10Dataset(train_data, transform=pretrained_model.image_preprocessor)
    test_data = torchvision.datasets.CIFAR10(root='./data', train=False, download=True)
    test_data = CustomCIFAR10Dataset(test_data, transform=pretrained_model.image_preprocessor)
